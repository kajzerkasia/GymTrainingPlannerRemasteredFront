...
const Exercises = ({ exercisesData }) => {
  ...
  const buttonClasses =
    "bg-violet text-almost-white uppercase w-32 h-32 border-none text-base py-4 font-button";
